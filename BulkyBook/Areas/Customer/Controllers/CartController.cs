...
namespace BulkyBook.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        private TwilioSender _twilioSender { get; set; }
        private readonly UserManager<IdentityUser> _userManager;
        
        public ShoppingCartVM shoppingCartVM { get; set; }
        public CartController(IUnitOfWork unitOfWork, IEmailSender emailSender,
            UserManager<IdentityUser> userManager,IOptions<TwilioSender>twilioSender)
        {
            _unitOfWork = unitOfWork;
            _emailSender = emailSender;
            _userManager = userManager;
            _twilioSender = twilioSender.Value;
        }
        ...
        public IActionResult SummaryPost(ShoppingCartVM shoppingCartVM,string stripeToken)
        {
            ...
            if (stripeToken == null)
            {
                //delayed payment for authorized company
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            TwilioClient.Init(_twilioSender.AccountSID, _twilioSender.AuthToken);
            try
            {
                var message = MessageResource.Create(
                    body: "Order placed on Bulky Book. Your order ID:" + id,
                    from: new Twilio.Types.PhoneNumber(_twilioSender.PhoneNumber),
